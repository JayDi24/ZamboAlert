      ...
      <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
        <ScrollView contentContainerStyle={styles.scroll} keyboardShouldPersistTaps="handled" showsVerticalScrollIndicator={false}>
          <View style={styles.authCard}>
            <Text style={styles.kicker}>Emergency access</Text>
            <Text style={styles.heading}>Welcome back</Text>
            <Text style={styles.sub}>
              Sign in to continue and stay connected when every second counts.
            </Text>
...
const styles = StyleSheet.create({
  ...
  heading: { fontFamily: 'Inter_700Bold', fontSize: 30, color: colors.textPrimary, marginTop: 6 },
  sub: { marginTop: 6, marginBottom: 20, lineHeight: 20, fontFamily: 'Inter_400Regular', fontSize: 13.5, color: colors.textSecondary },
  ...
  lockoutBox: { flexDirection: 'row', alignItems: 'center', gap: 8, backgroundColor: 'rgba(224,52,43,0.08)', borderRadius: 12, padding: 12, marginBottom: 8 },
  ...
  demoBox: { flexDirection: 'row', alignItems: 'flex-start', gap: 8, backgroundColor: colors.inactiveBg, borderRadius: 12, padding: 12, marginBottom: 20 },
